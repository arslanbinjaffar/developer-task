...
const Hero = () => {
    return (
      <>
            <div className='max-w-[1206px] w-full mt-5 lg:mt-14 mx-auto hidden md:flex justify-center lg:items-start items-center lg:gap-40 gap-10 flex-col lg:flex-row 
      ...
      '>
        ...
        <TextInput id="password1" type="password" required />
           ...
           <p className='font-medium text-base mt-2 mb-8 text-bluishCyan'>Forgot Password?</p>
                  <Button type="submit" className='w-full bg-bluishCyan capitalize'>log in</Button>
